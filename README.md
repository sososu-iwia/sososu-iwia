<h1 align="center"> Hi, I'm Damir Yerbolatov</h1>
...
```yaml
name: Damir Yerbolatov
role: Backend & Full-Stack Developer
focus: [ "Scalable Systems", "Clean Architecture", "Performance" ]
currently_learning: [ "DevOps", "SRE", "Cloud Infrastructure" ]
philosophy: "Write code that humans can read and machines can scale."
```
...
| :--- | :--- | :--- |
|  **finance-app** | Personal finance management backend | Java · Spring · PostgreSQL |
|  **oop4** | Educational institution management system | Java · OOP · SQL |
|  **back-front-NoSQL** | Full-stack NoSQL application | Node.js · MongoDB · React |

>  *More projects coming soon — building, breaking, and learning.*
